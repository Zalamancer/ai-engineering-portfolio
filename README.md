...
| 2 | [`02-model-regression/`](02-model-regression/) | #1 Model Regression Detection System (pp. 3–5) | Local + GitHub Actions (+ TypeSafe Jev API) | Built, 16 tests pass; LLM gate demo done; Jev backend added 2026-09-21 — 85.0 → 97.5 % in four gated prompt versions, see `02-model-regression/README.md` |
